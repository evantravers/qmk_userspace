...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_wrapper(
    ...
    _________________QWERTY_L3_________________, _______, _______, _________________QWERTY_R3_________________,
        _______, _______, ______LH_THUMBS_2____, _______, _______, ______RH_THUMBS_2____, _______, _______ \
  ),
  [_SYMBL] = LAYOUT_wrapper(
    ...
    _________________SYMBL_L3__________________, _______,  _______, _________________SYMBL_R3__________________,
       _______, _______, ____LH_THUMBS_SYM____, _______, _______, ____RH_THUMBS_SYM____, _______, _______ \
  ),
  ...
  [_SHORTCUTS] = LAYOUT_wrapper(
    ...
    _______________SHORTCUTS_L3________________, _______,  _______, _______________SHORTCUTS_R3________________,
       _______, _______, ____LH_THUMBS_SHT____, _______, _______, ____RH_THUMBS_SHT____, _______, _______ \
  ),

  [_NUDGE] = LAYOUT_wrapper(
    _________________NUDGE_R1__________________,                    ___________________BLANK___________________,
    _________________NUDGE_R2__________________,                    ___________________BLANK___________________,
    _________________NUDGE_R3__________________, _______,  _______, ___________________BLANK___________________,
       _______, _______, ____LH_THUMBS_NDG____, _______, _______, ____RH_THUMBS_NDG____, _______, _______ \
  ),
