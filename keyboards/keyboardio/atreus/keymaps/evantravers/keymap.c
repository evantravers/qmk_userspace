...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MOUSE] = LAYOUT_wrapper(
    _MOUSE_1,                                                        ___________________BLANK___________________,
    _MOUSE_2,                                                        ___________________BLANK___________________,
    ___________________BLANK___________________, _______,  _______, _MOUSE_3, _______,
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
  ),
