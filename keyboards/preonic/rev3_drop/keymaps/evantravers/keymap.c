...
[_GAMING2] = LAYOUT_preonic_2x2u_wrapper(
  ...
  KC_PGUP, _______, _______, _______, _______, _______, ______________ARROWS______________, _______, _______,
...
[_QWERTY] = LAYOUT_preonic_2x2u_wrapper(
  ...
  _______,  _______, ______LH_THUMBS_2____, ______RH_THUMBS_2____, _______, _______
),
...
[_MOUSE] = LAYOUT_preonic_2x2u_wrapper(
  ___________________BLANK___________________, _______, _______, ___________________BLANK___________________,
  _MOUSE_1,                                    _______, _______, _______, _______, _______, KC_RGUI, KC_RALT,
  _MOUSE_2,                                    _______, _______, _MOUSE_3,                           KC_RCTL,
  ___________________BLANK___________________, _______, _______, _______, _______, _______, _______, KC_RSFT,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
